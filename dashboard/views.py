...
def admin_dashboard(request):
    ...
    context = {
        ...
        "latest_tutorials": Tutorial.objects.select_related("department").order_by("-created_at")[:6],
    }
...
def editor_dashboard(request):
    ...
    tutorials_qs = Tutorial.objects.filter(department=dept)
...
def user_dashboard(request):
    ...
    recent_history = (
        ReadHistory.objects.select_related("tutorial")
